...
//    sru_init_sharc_sam();
	...
	SRU2(HIGH, DAI1_PBEN05_I);	// mute
	SRU2(HIGH, DAI1_PBEN04_I);	// enable
	SRU(HIGH, DAI0_PBEN18_I);	// i2c mux reset

    // mute the ma12040p amps
	SRU2(LOW, DAI1_PB05_I);

    // enable the ma12040p amps
	...
	*/
	...
	SRU2(HIGH, DAI1_PBEN01_I);	// I2S CLK
	SRU2(HIGH, DAI1_PBEN02_I);	// I2S WS

    // route PCGC CLK and FS signals to I2S CLK and WS
    SRU2(PCG0_CLKC_O, DAI1_PB01_I);		// I2S CLK
    SRU2(PCG0_FSC_O, DAI1_PB02_I);  	// I2S WS
	...
	*/
    ...
    SRU2(HIGH, DAI1_PBEN11_I);	// SDA0
    SRU2(HIGH, DAI1_PBEN12_I);	// SDA1
    SRU2(HIGH, DAI1_PBEN13_I);	// SDA2
    SRU2(HIGH, DAI1_PBEN14_I);	// SDA3
    SRU2(HIGH, DAI1_PBEN15_I);	// SDA4
    SRU2(HIGH, DAI1_PBEN16_I);	// SDA5
    SRU2(HIGH, DAI1_PBEN17_I);	// SDA6
    SRU2(HIGH, DAI1_PBEN18_I);	// SDA7
    SRU2(HIGH, DAI1_PBEN19_I);	// SDA8
    SRU2(HIGH, DAI1_PBEN20_I);	// SDA9

    // route SPORT4 data lines
    SRU2(SPT4_AD0_O, DAI1_PB11_I);	// SDA0
    SRU2(SPT4_AD1_O, DAI1_PB12_I);	// SDA1
    SRU2(SPT4_BD0_O, DAI1_PB13_I);	// SDA2
    SRU2(SPT4_BD1_O, DAI1_PB14_I);	// SDA3

    // route SPORT5 data lines
	SRU2(SPT5_AD0_O, DAI1_PB15_I);	// SDA4
	SRU2(SPT5_AD1_O, DAI1_PB16_I);	// SDA5
	SRU2(SPT5_BD0_O, DAI1_PB17_I);	// SDA6
	SRU2(SPT5_BD1_O, DAI1_PB18_I);	// SDA7

	// route SPORT5 data lines
	SRU2(SPT6_AD0_O, DAI1_PB19_I);	// SDA8
	SRU2(SPT6_AD1_O, DAI1_PB20_I);	// SDA9
